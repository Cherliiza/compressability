...
Програму також можна запускати без відкриття проєкту у Visual Studio. Для цього необхідно:

1. Розпакувати zip-архів програми.
2. Відкрити папку:

```text
Comperssability/bin/Debug/
```
...
Після цього програма зчитає текстові файли, виконає стиснення та відобразить результати у вкладках інтерфейсу.
